...
from api import get_ski_resort_forecast  # Ensure api.py is in the project directory
...
app = Flask(__name__)
    ...
    def home():
        ...
        resort_id = "999001"  # This should be dynamically determined based on your application's logic
